...
export interface VrakenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "setTransactionFeePercentage",
    values: [BigNumberish]
  ): string;
...
export interface Vraken extends BaseContract {
  connect(runner?: ContractRunner | null): Vraken;
  waitForDeployment(): Promise<this>;

  interface: VrakenInterface;
  ...
  setMinter: TypedContractMethod<
    [account: AddressLike, canMint: boolean],
    [void],
    "nonpayable"
  >;

  setTransactionFeePercentage: TypedContractMethod<
    [newFee: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setTransactionFeePercentage"
