...
export interface MyVokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowances"
      | "approve"
...
export interface MyVoken extends BaseContract {
  connect(runner?: ContractRunner | null): MyVoken;
  waitForDeployment(): Promise<this>;

  interface: MyVokenInterface;
